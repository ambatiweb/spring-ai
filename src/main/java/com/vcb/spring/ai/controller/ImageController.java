...
public class ImageController {
    ...
    public String describeImage(){
        String response =  ChatClient.create(chatModel)
                ...
                .user(userSpec -> userSpec.text("Explain what you see in this Image")
                        .media(MimeTypeUtils.IMAGE_JPEG, new ClassPathResource("images/horse.jpg")))
                .call()
                .content();
    ...
    public String generateImage(@PathVariable String prompt) {
        ...
        ImageResponse response = imageModel.call(new ImagePrompt(prompt, OpenAiImageOptions.builder().withN(1)
                .withWidth(1024)
                .withHeight(1024)
                .withQuality("hd")
                .build()));
